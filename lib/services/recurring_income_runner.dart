...
import 'recurring_income_repository.dart';

class RecurringIncomeRunner {
  RecurringIncomeRunner._();
  ...
  static Future<int> runForUser(int userId) async {
    ...
    final templates = await RecurringIncomeRepository.instance.getActiveForUser(
      userId,
    );
    var insertedCount = 0;
